...
public class EventTestRunnerDelete {
	...
	public void openDeleteEvent() {
		...
		driverDelete.findElement(By.className("ids")).sendKeys("104");
		driverDelete.findElement(By.name("delete")).submit();
		System.out.println(driverDelete.getTitle());
	...
	public static void main(String[] args) {
		...
		EventTestRunnerDelete obj = new EventTestRunnerDelete();
